    ...
    try:
        ...
        if cached_facts:
            ...
            prompt = (
                ...
                "- Broker = the wholesale broker/MGA who PREPARED the quote. "
                "Producer/Account Executive = the retail agent the quote is PREPARED FOR.\n"
                "- Do not fill computed/total fields unless the exact figure is stated on the quote.\n"
